...
const AbstractIcon = () => (
    <svg 
        ...
        strokeWidth={1.5} 
        stroke="currentColor" 
        className="w-7 h-7 theme-accent-text" // Using global accent class
    >
...
const Navbar = () => {
  ...
  return (
    <div className="navbar sticky top-0 z-10 shadow-xl text-gray-50 
      ...
      {/* 1. Mobile/Tablet Dropdown Menu (Hamburger) */}
      <div className="navbar-start">
        <div className="dropdown">
          ...
          {/* Dropdown menu list - must be light/white for legibility */}
          ...
          <>
            ...
            <div className="dropdown dropdown-end ml-2">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                <div className="w-10 rounded-full border-2 border-emerald-400"> {/* Primary accent border */}
